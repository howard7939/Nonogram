    ...
    while True:
        ...
        if do_something == False:
            if threshold > threshold_max:
                ...
                print('threshold updated, multiplied by', threshold_multiplier)
                print('new threshold =', threshold)
        elif threshold > 1:
            threshold /= threshold_multiplier
            print('threshold updated, divided by', threshold_multiplier)
            print('new threshold =', threshold)
...
def main():
    ...
    rows_condition = [
        2,6,44,1,10,44,1,5,2,44,1,3,2,2,44,3,2,2,1,1,2,44,2,2,3,2,2,44,4,2,3,44,1,4,3,44,2,6,3,3,44,3,5,3,44,1,7,3,44,1,1,12,1,44,1,8,2,2,44,2,8,2,1,44,2,3,2,3,44,3,1,5,44,3,3,1,1,44,2,2,3,3,44,1,1,1,1,1,44,2,1,3,2,1,2,44
    ]
    cols_condition = [
        1,2,2,2,44,1,1,2,3,1,44,6,1,6,44,2,2,3,44,3,2,1,44,12,44,13,3,44,3,8,2,1,44,2,1,9,1,44,3,2,6,2,44,2,2,4,1,1,44,2,4,4,44,2,3,1,4,44,2,1,2,1,1,2,44,2,2,1,2,1,44,2,3,1,3,44,3,2,5,44,8,2,3,44,10,1,44,4,1,44
    ]
